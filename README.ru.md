...
В актуальный официальный набор входит импортёр DokuWiki и Obsidian: он
анализирует выбранную папку или поддерживаемый архив, предлагает редактируемую
структуру и только после подтверждения публикует её в `Импортировано`.
